...
import com.example.GameOn.repository.TimeslotRepository;
...
//
//    public TimeSlotService(ReactiveMongoTemplate mongoTemplate) {
//        this.mongoTemplate = mongoTemplate;
//    }
//
////    private static final PasswordEncoder passwordEn = new BCryptPasswordEncoder();
//
//    public Mono<TimeSlots> save(TimeSlots myEntry){
...
//    }
//
//    public Flux<TimeSlots> getFilteredList(Map<String, Object> filters, int page, int size, String sortBy, String sortOrder) {
...
//
//        return mongoTemplate.find(query, TimeSlots.class);
//    }
//
////    public Page<TimeSlots> getAll(Pageable pageable) {
////        return repository.findAll(pageable);
////    }
//
//    public Mono<TimeSlots> saveNew(TimeSlots myEntry){
//        myEntry.setCreatedOn(LocalDateTime.now(ZoneId.of("Asia/Kolkata")).toInstant(ZoneId.of("UTC").getRules().getOffset(Instant.now())).toEpochMilli());
//        myEntry.setLastUpdatedOn(LocalDateTime.now(ZoneId.of("Asia/Kolkata")).toInstant(ZoneId.of("UTC").getRules().getOffset(Instant.now())).toEpochMilli());
//        return repository.save(myEntry);
//    }
...
////    }
//
//    public Mono<TimeSlots> getById(ObjectId id){
